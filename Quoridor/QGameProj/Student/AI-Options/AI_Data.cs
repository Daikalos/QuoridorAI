...
{
    public const uint predictionFreq = 3;       // The less, more often to try to prevent opponent from placing walls against you
    ...
    public const float edgeWeightFactor = 0.7f; // The higher, the more try to steer away from walls
}
